...
export class WeatherService {
  ...
  getForecast(loc: string) {
    ...
    //  return this.http.get(`${environment.apiUrl}/forecast/daily?q=${loc}&cnt=${7}&appid=${apiKey}`);
  }
  ...
  getHour(loc: string) {
    return this.http.get(`${environment.apiUrl}/forecast/hourly?q=${loc}&appid=${apiKey}`)
  }
}
